---
name: proxy-setup
description: Configure and verify residential HTTP or SOCKS5 proxies for curl, Python Requests, and application workflows. Use when a user asks to set up a proxy, choose rotating or sticky sessions, check an exit IP, or troubleshoot proxy authentication, timeouts, and connection errors.
license: MIT
---
